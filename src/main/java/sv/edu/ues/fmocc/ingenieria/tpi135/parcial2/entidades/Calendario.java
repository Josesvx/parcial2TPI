...
public class Calendario implements Serializable {
    ...
    @JoinTable(name = "orden_trabajo_calendario", joinColumns = {
        @JoinColumn(name = "id_fecha", referencedColumnName = "id_fecha")}, inverseJoinColumns = {
    ...
    public String toString() {
        return "sv.edu.ues.fmocc.ingenieria.tpi135.parcial2.entidades.Calendario[ idFecha=" + idFecha + " ]";
    }
